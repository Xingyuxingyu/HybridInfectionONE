...
public class SimpleCommunityDetection implements CommunityDetection
{
	...
	{//a[-1] =1;
		...
		/*
		Iterator it = localCommunity.iterator() ;
		while( it.hasNext() )
		{
			System.out.println( this.localCommunity + " " +it.next().toString());
		}
		
		Iterator it2 = scd.localCommunity.iterator() ;
		while( it2.hasNext() )
		{
			System.out.println(  scd.localCommunity + " " +it2.next().toString());
		}*/
		
		//System.out.println( myHost.toString() + " " + this.localCommunity );
		//System.out.println( peer.toString() + " " + scd.localCommunity );
		//System.out.println( localCommunity.size() + " " + scd.localCommunity.size() ) ;
	}
